...
parser.add_argument('--lock_bn', action='store_true')
parser.add_argument('--model', type=str, default='resnet')
parser.add_argument('--dual_custom', action='store_true')
...
from data_res import data_transforms
...
from nets import p4mres_1 as p4m_test
if args.model=='resnet':
    model = resnet.resnet18(False, dp=args.p, lock_bn=args.lock_bn, optimized=args.optimized)
elif args.model=='p4mres':
    model = p4mres.resnet18(False, dp=args.p, lock_bn=args.lock_bn, optimized=args.optimized)
elif args.model=='test':
    model = p4m_test.resnet18(False, dp=args.p, lock_bn=args.lock_bn, optimized=args.optimized)
...
for epoch in range(1, args.epochs + 1):
    ...
    if dual_custom:
        model_file = "models/" + args.name + '_dc' + args.ftn  +'/model_' + str(epoch) +'_{:.9f}'.format(loss) + '.pth'
    elif args.load:
